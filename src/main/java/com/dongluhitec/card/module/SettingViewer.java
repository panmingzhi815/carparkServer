	...
	public SettingViewer() {
		...
		button_1.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				cs.setPlateDeviceip(text_1.getText().trim());
		...
		button_1.setBounds(210, 448, 72, 22);
		button_1.setText("保存");
		createContents();
		...
		label_7.setBounds(10, 101, 60, 19);
		...
		combo_supportIn.setBounds(76, 97, 105, 32);
		...
		label_8.setBounds(195, 99, 60, 21);
